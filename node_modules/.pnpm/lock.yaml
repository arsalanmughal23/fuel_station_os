...
importers:
  ...
  .:
    ...
    devDependencies:
      ...
      laravel-vite-plugin:
        specifier: ^2.0.0
        version: 2.1.0(vite@7.3.6(jiti@2.7.0)(lightningcss@1.32.0))
      tailwindcss:
        specifier: ^4.0.0
        version: 4.3.3
      vite:
...
packages:
  ...
  '@nanmicoder/dsh-agent-teams@0.1.14':
    resolution: {integrity: sha512-XpNqwQJjHQJsiZgdHRUuzvdODWPwHYIKr2EJl588XOnRQD6LSf1o3hYWBvdOku3LqKFpCUioM8ApGn0K2sMtlQ==}
...
snapshots:
  ...
  laravel-vite-plugin@2.1.0(vite@7.3.6(jiti@2.7.0)(lightningcss@1.32.0)):
    dependencies:
      picocolors: 1.1.1
      vite: 7.3.6(jiti@2.7.0)(lightningcss@1.32.0)
      vite-plugin-full-reload: 1.2.0
